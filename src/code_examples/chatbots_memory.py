...
Original file is located at
    https://colab.research.google.com/github/langchain-ai/langchain/blob/master/docs/docs/how_to/chatbots_memory.ipynb
...
# %pip install --upgrade --quiet langchain langchain-google-genai langgraph
